...
const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  ...(CALENDAR_SYNC_SETTINGS_VISIBLE
    ? [{ id: 'calendar', icon: Calendar, labelKey: 'nav.calendar', iconStyle: 'bg-sky-500/12 text-sky-600 dark:text-sky-400' } as SettingsSection]
    : []),
  {
    id: 'email',
    icon: Mail,
  ...
  },
  {
    ...
    iconStyle: 'bg-red-500/12 text-red-600 dark:text-red-400',
  },
];
