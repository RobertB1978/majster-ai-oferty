...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  navigation: {
    mainItems: [
      ...
      { id: 'team', label: 'Zespół', path: '/app/team', icon: 'UserPlus', visible: true, comingSoon: false, requiredPlan: 'pro', order: 6 },
      { id: 'marketplace', label: 'Marketplace', path: '/app/marketplace', icon: 'Store', visible: true, comingSoon: false, requiredPlan: 'business', order: 7 },
      { id: 'analytics', label: 'Analityka', path: '/app/analytics', icon: 'BarChart3', visible: true, comingSoon: false, requiredPlan: 'business', order: 8 },
