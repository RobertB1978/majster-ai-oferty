          ...
          <div className="relative aspect-video bg-[#0A0A0A]">
            {playing ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                {/* Play button — the primary interactive element */}
                <button
                  type="button"
                ...
                >
                  {/* Outer ambient ring */}
                  <div
                    className="absolute inset-0 rounded-full bg-accent-amber/15 scale-[1.6] group-hover:scale-[1.85] transition-transform duration-500 ease-out"
                    aria-hidden="true"
                  />
                  {/* Inner ring */}
                  <div
                    className="absolute inset-0 rounded-full bg-accent-amber/10 scale-[1.28] group-hover:scale-[1.4] transition-transform duration-400 ease-out"
                    aria-hidden="true"
                  />
                  {/* Button */}
                  <div className="relative w-20 h-20 rounded-full bg-accent-amber hover:bg-accent-amber-light active:bg-accent-amber-hover flex items-center justify-center shadow-lg shadow-accent-amber/30 group-hover:shadow-xl group-hover:shadow-accent-amber/40 transition-all duration-300">
                    <Play
