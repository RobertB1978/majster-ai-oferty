...
export function NewShellDesktopSidebar() {
  ...
  return (
    <aside
      className="hidden lg:flex flex-col w-56 shrink-0 border-r border-border/60 bg-gradient-warm-surface sticky top-12 h-[calc(100vh-3rem)] overflow-y-auto shadow-[2px_0_10px_-3px_rgba(0,0,0,0.06)] dark:shadow-[2px_0_10px_-3px_rgba(0,0,0,0.25)]"
