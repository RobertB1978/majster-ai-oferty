...
| Deployment truth (Vercel) | `docs/DEPLOYMENT_TRUTH.md`, `docs/VERCEL_SETUP_CHECKLIST.md`, `vercel.json` | PR#01 | Checklista + screeny + build log | TODO |
| Deployment truth (Supabase) | `docs/DEPLOYMENT_TRUTH.md`, `supabase/migrations/*`, `supabase/functions/*` | PR#02 | Porównanie migracji/functions + wynik RLS | TODO |
