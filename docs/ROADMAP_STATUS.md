...
| **PR-08** | CRM + Cennik | ✅ DONE | `claude/review-roadmap-development-oDn2X` | 2026-03-26 | Migracja clients.nip, walidacja NIP (algorytm sumy kontrolnej PL), pole NIP w formularzu + karcie klienta, Client interface + zapytania SELECT, i18n PL/EN/UK (clients.nip + validations.client.nipInvalid), test IDOR 15 przypadków (clients + item_templates), ItemTemplates.tsx CRUD był już gotowy (RLS ✅) |
